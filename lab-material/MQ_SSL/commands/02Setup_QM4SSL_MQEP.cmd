...
@call mqsicreatepolicy %nodeC% -t MQEndpoint -l %PolC% -f  c:\student10\MQ_SSL\Resources\Policy\QM4SSLConsumerPolicy.xml
...
@call mqsicreatepolicy %nodeP% -t MQEndpoint -l %PolP% -f  c:\student10\MQ_SSL\Resources\Policy\QM4SSLProviderPolicy.xml
