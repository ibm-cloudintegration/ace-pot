...
mqsireportproperties %nodeP% -o ComIbmJVMManager -a -e %servP% > C:\student10\WSSecurity\commands\%nodeP%_servP%_PKIEncryptionConfigReport.txt
...
mqsireportproperties %nodeC% -o ComIbmJVMManager -a -e %servC% > C:\student10\WSSecurity\commands\%nodeC%_%servC%_PKIEncryptionConfigReport.txt
...
mqsistart %nodeC%
echo Ready to run 04PSBSetupEncryption
