...
mqsireportproperties %nodeP% -c PolicySetBindings -o myProviderPolicySetBinding -r > %nodeP%EncryptPartialMSGPolicySetsBinding.txt
...
mqsireportproperties %nodeC% -c PolicySets -o myConsumerPolicySet -r > %nodeC%EncryptPartialMSGPolicySet.txt

echo - reporting CONSUMER Policy Set Binding
mqsireportproperties %nodeC% -c PolicySetBindings -o myConsumerPolicySetBinding -r > %nodeC%EncryptPartialMSGPolicySetsBinding.txt
...
mqsistart %nodeC%
echo -  
echo ready to rerun scenario for partial message encryption ....