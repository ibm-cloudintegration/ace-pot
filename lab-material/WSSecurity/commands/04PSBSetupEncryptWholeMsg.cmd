...
@echo Importing PROVIDER Policy Set For EncryptWholeMsg
...
@echo Importing PROVIDER Policy Set Binding for EncryptWholeMsg
...
mqsireportproperties %nodeP% -c PolicySets -o myProviderPolicySet -r > %Reps%EncryptFull%nodeP%_%servP%_PSConfig.txt

@echo reporting PROVIDER Policy Set Binding
mqsireportproperties %nodeP% -c PolicySetBindings -o myProviderPolicySetBinding -r > %Reps%EncryptFull%nodeP%_%servP%_PSBConfig.txt
...
mqsireportproperties %nodeC% -c PolicySets -o myConsumerPolicySet -r > %Reps%EncryptFull%nodeC%_%servC%_PSConfig.txt

@echo reporting CONSUMER Policy Set Binding
mqsireportproperties %nodeC% -c PolicySetBindings -o myConsumerPolicySetBinding -r > %Reps%EncryptFull%nodeC%_%servC%_PSBConfig.txt
...
mqsistart %nodeC%
@echo -  
@echo 04PSBSetupEncryptWholeMsg command complete.