...
REM *****************************************************
echo Betaworks WS Policy Set and PolicySet binding export .
...
mqsireportproperties %node1% -c PolicySets -o %ps1% -n ws-security -p AuthenticationOnly%ps1%.xml
echo - 
echo Extracting %psb1% Policy Set Binding
mqsireportproperties %node1% -c PolicySetBindings -o %psb1% -n ws-security -p AuthenticationOnly%psb1%.xml
echo - 
