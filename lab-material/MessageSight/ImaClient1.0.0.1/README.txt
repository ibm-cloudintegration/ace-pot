IBM® MessageSight™ JMS Client V1.0.0.1
July 2013
...
===================================
The ImaJmsClientV1.0.0.1.zip package provides the IBM MessageSight client 
...
these steps:
1. Unzip the contents of ImaJmsClientV1.0.0.1. 
